...
% preamble
\name{Nikita}{Kiselev}
\quote{\textit{\href{https://latexonline.cc/compile?git=https://github.com/kisnikser/CV&target=resume.tex&command=xelatex&force=true}{\textcolor{gray}{Check my Resume (short version)}}}\\\vspace{1em}Data Scientist, Optimization Researcher}
