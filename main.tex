...
\begin{enumerate}
    \item D.~Yarmoshik, D.~Kovalev, A.~Rogozin, N.~Kiselev, D.~Dorin, A.~Gasnikov. Decentralized Optimization with Coupled Constraints. // Submitted to the \href{https://neurips.cc}{\textbf{NeurIPS 2024}} conference with average rating 5.5. 
