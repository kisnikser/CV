...
% preamble
\name{Nikita}{Kiselev}
\quote{\textit{\href{https://latexonline.cc/compile?git=https://github.com/kisnikser/CV&target=resume.tex&command=xelatex&force=true}{\textcolor{gray}{Check my Resume (one-page version)}}}\\\vspace{1em}Data Scientist, Optimization Researcher}
...
\subsection{Accepted Papers (\textbf{1 $\times$ Q2})}
\begin{enumerate}
    ...
    Will be published in the \href{https://link.springer.com/journal/11472}{Doklady Mathematics} journal
\end{enumerate}
